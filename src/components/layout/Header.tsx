  ...
  useEffect(() => {
    if (navigator.geolocation) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          // In a real app, would reverse geocode these coords
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-card shadow-sm">
        {/* Row 1: Top Bar - Delivery & Language/Currency (Desktop Only) */}
              ...
              <div className="flex items-center gap-3">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="bg-card">
                    <DropdownMenuLabel className="text-xs">Langue</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    {languages.map((lang) => (
                      <DropdownMenuItem
                        key={lang.code}
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="bg-card">
                    <DropdownMenuLabel className="text-xs">Devise</DropdownMenuLabel>
                    <DropdownMenuSeparator />
                    {currencies.map((curr) => (
                      <DropdownMenuItem
                        key={curr.code}
        ...
        <div className="bg-primary text-primary-foreground">
          <div className="container mx-auto px-3 sm:px-4">
            <div className="flex items-center justify-between h-12 lg:h-14 gap-2">
              {/* Left - Mobile Menu */}
              ...
              <Link to="/" className="flex items-center gap-2 flex-shrink-0">
                ...
                />
                <span className="font-heading font-bold text-base sm:text-lg lg:text-xl text-primary-foreground hidden xs:block">
                  NUKUCONNECT
                </span>
              </Link>
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="w-72 bg-card">
                    <DropdownMenuLabel className="flex items-center justify-between text-xs">
                      ...
                      {unreadCount > 0 && (
                        <button onClick={markAllAsRead} className="text-primary text-[10px]">
        ...
        {/* Row 4: Desktop Navigation with Categories */}
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                placeholder="Ex: Quartier Bè, Lomé, Togo"
            ...
            <div className="flex gap-2">
              <Button variant="outline" className="flex-1 text-xs" onClick={() => setLocationDialogOpen(false)}>
                Annuler
              </Button>
              <Button variant="hero" className="flex-1 text-xs" onClick={handleSaveLocation}>
                Enregistrer
              </Button>
            </div>
          </div>
