      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <Card className="bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
          <CardContent className="p-3 sm:p-4">
            ...
            <p className="text-lg sm:text-xl font-bold text-foreground">{totalEarnings.toLocaleString("en-US")} FCFA</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-3 sm:p-4">
            ...
            <p className="text-lg sm:text-xl font-bold text-foreground">{totalWithdrawn.toLocaleString("en-US")} FCFA</p>
          </CardContent>
        </Card>
        <Card className="bg-gradient-to-br from-green-500/10 to-green-500/5 border-green-500/20">
          <CardContent className="p-3 sm:p-4">
            ...
            <p className="text-lg sm:text-xl font-bold text-green-600">{availableBalance.toLocaleString("en-US")} FCFA</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        <CardHeader className="p-3 sm:p-4 pb-2">
          ...
          <CardDescription className="text-[10px] sm:text-xs">
            Minimum 500 FCFA · Traitement sous 24-48h · Seules les ventes réellement payées sont comptabilisées.
          </CardDescription>
        </CardHeader>
                  ...
                  <div key={w.id} className="flex items-center justify-between p-2.5 bg-muted/50 rounded-xl gap-2">
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="text-xs font-medium">{Number(w.amount).toLocaleString("en-US")} FCFA</p>
