...
export default function MonerooTransactions() {
  ...
  const load = async () => {
    setLoading(true);
    let q = supabase.from("moneroo_transactions" as any).select("*").order("created_at", { ascending: false }).limit(200);
