...
const plans = [
  {
    id: "free", name: "Gratuit", price: 0, maxProducts: 5, commission: 8,
    description: "Démarrer gratuitement", icon: Zap, color: "bg-muted", popular: false,
    features: [
      "Jusqu'à 5 produits publiés",
      "Accès complet au Marketplace",
      "Messagerie acheteurs / fournisseurs",
      "Statistiques de base",
      "Accès à NukuConnect AI",
      "Vérification KYC gratuite (badge vérifié)",
      "Commission 8% sur les ventes",
    ],
    limitations: ["Pas de mise en avant produits", "Pas de traçabilité QR"],
  },
  {
    id: "starter", name: "Starter", price: 2500, maxProducts: 15, commission: 8,
    description: "Pour démarrer activement", icon: Sparkles, color: "bg-secondary", popular: false,
    features: [
      "Jusqu'à 15 produits publiés",
      "4 crédits boosts produits / an",
      "Module Traçabilité produits (QR codes)",
      "Mise en avant des produits",
      "NukuConnect AI illimité",
